...
2. The spreadsheet need to be manually adjusted to impute suppressed values before proceeding.
...
1. We can produce the latest input weights using `input_weights`
